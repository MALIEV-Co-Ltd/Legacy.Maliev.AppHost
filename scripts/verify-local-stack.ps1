...
try {
    ...
    Write-Host "PASS: PostgreSQL, Redis, 16 services, 23 migrations, 23 preserved databases plus Auth runtime state, public Career and Contact boundaries, standalone Accounting protection, public instant quotation, recorded local security notifications, customer/employee login, authenticated Member and Intranet flows, and environment isolation are healthy. Evidence: $EvidencePath"
}
catch {
